...
pub struct RegisterBlock {
    ...
    pub wavebuf: WAVEBUF,
    _reserved_21_perbuf: [u8; 0x04],
    _reserved_22_ccbuf: [u8; 0x10],
}
impl RegisterBlock {
    #[doc = "0x34 - Count"]
    #[inline(always)]
...
#[doc = "Pattern Buffer"]
pub mod pattbuf;
#[doc = "WAVEBUF (rw) register accessor: an alias for `Reg<WAVEBUF_SPEC>`"]
pub type WAVEBUF = crate::Reg<wavebuf::WAVEBUF_SPEC>;
