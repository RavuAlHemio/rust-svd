...
pub struct RegisterBlock {
    _reserved_0_mode0: [u8; 0x50],
}
impl RegisterBlock {
    #[doc = "0x00..0x50 - Clock/Calendar with Alarm"]
    #[inline(always)]
    pub const fn mode2(&self) -> &MODE2 {
        unsafe { &*(self as *const Self).cast::<u8>().add(0usize).cast() }
    }
    #[doc = "0x00..0x50 - 16-bit Counter with Two 16-bit Compares"]
    #[inline(always)]
    pub const fn mode1(&self) -> &MODE1 {
        unsafe { &*(self as *const Self).cast::<u8>().add(0usize).cast() }
    }
    #[doc = "0x00..0x50 - 32-bit Counter with Single 32-bit Compare"]
    #[inline(always)]
