...
pub type PORT__W<'a, const O: u8> = crate::BitWriter<'a, u32, APBAMASK_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 1 - MCLK APB Clock Enable"]
    #[inline(always)]
    pub fn mclk_(&self) -> MCLK__R {
        MCLK__R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - RSTC APB Clock Enable"]
    #[inline(always)]
    pub fn rstc_(&self) -> RSTC__R {
        RSTC__R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - OSCCTRL APB Clock Enable"]
    #[inline(always)]
    pub fn oscctrl_(&self) -> OSCCTRL__R {
        OSCCTRL__R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - OSC32KCTRL APB Clock Enable"]
    #[inline(always)]
    pub fn osc32kctrl_(&self) -> OSC32KCTRL__R {
        OSC32KCTRL__R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - SUPC APB Clock Enable"]
    #[inline(always)]
    pub fn supc_(&self) -> SUPC__R {
        SUPC__R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - GCLK APB Clock Enable"]
    #[inline(always)]
    pub fn gclk_(&self) -> GCLK__R {
        GCLK__R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - WDT APB Clock Enable"]
    #[inline(always)]
    pub fn wdt_(&self) -> WDT__R {
        WDT__R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - RTC APB Clock Enable"]
    #[inline(always)]
    pub fn rtc_(&self) -> RTC__R {
        RTC__R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - EIC APB Clock Enable"]
    #[inline(always)]
    pub fn eic_(&self) -> EIC__R {
        EIC__R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bit 10 - PORT APB Clock Enable"]
    #[inline(always)]
    pub fn port_(&self) -> PORT__R {
        PORT__R::new(((self.bits >> 10) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PM APB Clock Enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn mclk_(&mut self) -> MCLK__W<1> {
        MCLK__W::new(self)
    }
    #[doc = "Bit 2 - RSTC APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rstc_(&mut self) -> RSTC__W<2> {
        RSTC__W::new(self)
    }
    #[doc = "Bit 3 - OSCCTRL APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn oscctrl_(&mut self) -> OSCCTRL__W<3> {
        OSCCTRL__W::new(self)
    }
    #[doc = "Bit 4 - OSC32KCTRL APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn osc32kctrl_(&mut self) -> OSC32KCTRL__W<4> {
        OSC32KCTRL__W::new(self)
    }
    #[doc = "Bit 5 - SUPC APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn supc_(&mut self) -> SUPC__W<5> {
        SUPC__W::new(self)
    }
    #[doc = "Bit 6 - GCLK APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn gclk_(&mut self) -> GCLK__W<6> {
        GCLK__W::new(self)
    }
    #[doc = "Bit 7 - WDT APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wdt_(&mut self) -> WDT__W<7> {
        WDT__W::new(self)
    }
    #[doc = "Bit 8 - RTC APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rtc_(&mut self) -> RTC__W<8> {
        RTC__W::new(self)
    }
    #[doc = "Bit 9 - EIC APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn eic_(&mut self) -> EIC__W<9> {
        EIC__W::new(self)
    }
    #[doc = "Bit 10 - PORT APB Clock Enable"]
    #[inline(always)]
    #[must_use]
    pub fn port_(&mut self) -> PORT__W<10> {
        PORT__W::new(self)
    }
