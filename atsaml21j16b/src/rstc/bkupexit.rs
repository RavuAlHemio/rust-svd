...
#[doc = "Field `EXTWAKE` reader - External Wakeup"]
pub type EXTWAKE_R = crate::BitReader<bool>;
...
impl R {
    #[doc = "Bit 0 - External Wakeup"]
    #[inline(always)]
    pub fn extwake(&self) -> EXTWAKE_R {
        EXTWAKE_R::new((self.bits & 1) != 0)
    }
