...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ovr8(&mut self) -> OVR8_W<8> {
        OVR8_W::new(self)
    }
    #[doc = "Bit 9 - Channel 9 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr9(&mut self) -> OVR9_W<9> {
        OVR9_W::new(self)
    }
    #[doc = "Bit 10 - Channel 10 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr10(&mut self) -> OVR10_W<10> {
        OVR10_W::new(self)
    }
    #[doc = "Bit 11 - Channel 11 Overrun Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ovr11(&mut self) -> OVR11_W<11> {
        OVR11_W::new(self)
    }
    #[doc = "Bit 16 - Channel 0 Event Detection Interrupt Enable"]
    #[inline(always)]
