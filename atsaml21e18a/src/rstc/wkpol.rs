...
pub type WKPOL_R = crate::FieldReader<u16, u16>;
#[doc = "Field `WKPOL` writer - Wakeup Polarity"]
pub type WKPOL_W<'a, const O: u8> = crate::FieldWriter<'a, u16, WKPOL_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Wakeup Polarity"]
    #[inline(always)]
    pub fn wkpol(&self) -> WKPOL_R {
        WKPOL_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - Wakeup Polarity"]
