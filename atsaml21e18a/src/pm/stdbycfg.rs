...
#[doc = "Field `AVREGSD` reader - Automatic VREG Switching Disable"]
pub type AVREGSD_R = crate::BitReader<bool>;
#[doc = "Field `AVREGSD` writer - Automatic VREG Switching Disable"]
pub type AVREGSD_W<'a, const O: u8> = crate::BitWriter<'a, u16, STDBYCFG_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 7 - Automatic VREG Switching Disable"]
    #[inline(always)]
    pub fn avregsd(&self) -> AVREGSD_R {
        AVREGSD_R::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn avregsd(&mut self) -> AVREGSD_W<7> {
        AVREGSD_W::new(self)
    }
    #[doc = "Bits 8:9 - Linked Power Domain"]
    #[inline(always)]
