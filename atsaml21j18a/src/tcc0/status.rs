...
#[doc = "Field `WAVEBUFV` reader - Wave Buffer Valid"]
pub type WAVEBUFV_R = crate::BitReader<bool>;
#[doc = "Field `WAVEBUFV` writer - Wave Buffer Valid"]
pub type WAVEBUFV_W<'a, const O: u8> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn wavebufv(&self) -> WAVEBUFV_R {
        WAVEBUFV_R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wavebufv(&mut self) -> WAVEBUFV_W<6> {
        WAVEBUFV_W::new(self)
    }
    #[doc = "Bit 7 - Period Buffer Valid"]
    #[inline(always)]
