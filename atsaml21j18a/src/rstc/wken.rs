...
pub type WKEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `WKEN` writer - Wakeup Enable"]
pub type WKEN_W<'a, const O: u8> = crate::FieldWriter<'a, u16, WKEN_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Wakeup Enable"]
    #[inline(always)]
    pub fn wken(&self) -> WKEN_R {
        WKEN_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - Wakeup Enable"]
